 ...
 * File:   main.cpp
 * Author: knguyen
 * Purpose: Writing pseudocode for rolls array and determining how top rolls playback would work, testing stub for how to save order, exploring vector.
 */
//sys lib
#include <iostream>
...
//function to sort, selection sort, void sort (array, size)
//function to search, binary search, void search (array, int size, int val, int& index)
...
int main(int argc, char** argv)
{
     ...
     *      or vector vector<int> rolls, loop i < vector.size()
     * enemies array, but would do same thing, just different name/stats
     *      bubble sort by hp, output based on sorting, sort hp, save original index into order array, output enemies using this order array, choose based on i and find order number to use to get value from array
     * 
     */
    ...
    /*
     ...
     array rolls
     for loop to 100, initialize each to 0
     then after each roll, using turn, add roll to array, if empty action remains 0
     */
    //enemy variables
    ...
    /*
     ...
     output sorted rolls, call sort function
 ...
 * var for high, low, middle
    do while dont continue if no changes
        ...
        if equal set index to middle, return found, dont continue
