 ...
 * File:   main.cpp
 * Author: knguyen
 * Purpose: Final version of project, testing and polishing code.
 */
...
void bubSrt (int [][5], int[]); //function to bubble sort
...
int main(int argc, char** argv)
{
    ...
    cout << endl << "A " << ename << "." << endl << "Ready?" << endl;
    cin >> yn;
...
void bubSrt (int values[][5], int order[])
{
    int copy[3]; //array to copy
    //copy array
    for (int i = 0; i < 3; i++)
    {
...
void prntm (string names[], int order[])
{
    ...
    for (int i = 0; i < 3; i++) //loop through array in new order
    {
